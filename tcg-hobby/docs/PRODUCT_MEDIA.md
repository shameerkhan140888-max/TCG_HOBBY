...
- TCG Hobby's own product photography
- authorised supplier media
- authorised distributor media
- authorised manufacturer retailer assets

Keep replacement filenames stable where possible so the product gallery, catalogue card, homepage featured product and Open Graph metadata continue to resolve without code changes.
