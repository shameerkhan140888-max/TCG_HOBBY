    ...
    <section className="section-block info-page">
      ...
      <div className="detail-panels">
        <article className="legal-board">
          ...
          <section>
            <h2>Delivery</h2>
            <p>Delivery options, prices and any available tracking information are shown during checkout or after dispatch where applicable. UK standard delivery is currently £3.99, with free standard UK delivery over £30 VAT-inclusive qualifying spend after discounts, excluding shipping. Estimated delivery windows are not guaranteed unless a selected service expressly says so.</p>
