      ...
      <div className="detail-panels">
        <article className="legal-board">
          ...
          <section>
            ...
            <p>UK standard delivery is £3.99, with free UK standard delivery over £30.00 qualifying spend. Delivery charges are confirmed during checkout and included in the final amount submitted for payment.</p>
