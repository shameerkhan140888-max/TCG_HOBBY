...
function product(overrides: Partial<{
  ...
  return {
    ...
    inventory: { id: `inventory-${overrides.id ?? 'product-1'}`, productId: overrides.id ?? 'product-1', stockOnHand: overrides.stockOnHand ?? 6, reservedStock: overrides.reservedStock ?? 0, reorderPoint: 0, locationCode: 'MAIN', updatedAt: new Date('2026-07-01T00:00:00.000Z') },
    images: [
      {
